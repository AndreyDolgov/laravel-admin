...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("/packages/admin/jquery-pjax/fix_problems.css") }}">

    <!-- REQUIRED JS SCRIPTS -->
    <script src="{{ asset ("/packages/admin/AdminLTE/plugins/jQuery/jQuery-2.1.4.min.js") }}"></script>
    <script src="{{ asset ("/packages/admin/AdminLTE/plugins/jQuery-ui/jquery.min.js") }}"></script>
    <script src="{{ asset ("/packages/admin/AdminLTE/bootstrap/js/bootstrap.min.js") }}"></script>
    <script src="{{ asset ("/packages/admin/cookies/cookies.js") }}"></script>
    ...
    <script src="{{ asset ("/packages/admin/jquery-pjax/fix_problems.js") }}"></script>
...
<script src="{{ asset ("/packages/admin/zclip/jquery.zclip.js") }}"></script>
...
<div id="ajax_preloader_background" class="ajax_hidden">
    <img id="ajax_preloader_image" class="ajax_hidden" src="/packages/admin/jquery-pjax/assets/ajax_loader.gif">
</div>
</body>
</html>
