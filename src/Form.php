 ...
 * @method Field\CheckboxRegionTree   checkboxRegionTree($column, $label = '')
 * @method Field\CheckboxTree   checkboxTree($column, $label = '')
 * @method Field\CheckboxCountries   checkboxCountries($column, $label = '')
 * @method Field\Radio          radio($column, $label = '')
 * @method Field\Select         select($column, $label = '')
 * @method Field\SelectOnRateType        selectOnRateType($column, $label = '')
 * @method Field\MultipleSelect multipleSelect($column, $label = '')
 * @method Field\MultipleSelectFilters  multipleSelectFilters($column, $label = '')
 * @method Field\Textarea       textarea($column, $label = '')
 * @method Field\Hidden         hidden($column, $label = '')
 * @method Field\FieldEmpty     fieldEmpty($column, $label = '')
 ...
 * @method Field\Map            maps($latitude, $longitude, $label = '')
 ...
 * @method Field\MarkdownEditor markdown($relationName, $callback)
 * @method Field\ContentBuilder contentBuilder($relationName, $callback)
 * @method Field\SwitchField    switch($column, $label = '')
 * @method Field\SwitchCallback switchCallback($column, $label = '')
...
class Form
{
    ...
    public static function registerBuiltinFields()
    {
        $map = [
            ...
            'checkboxRegionTree'=> \Encore\Admin\Form\Field\CheckboxRegionTree::class,
            'checkboxTree'      => \Encore\Admin\Form\Field\CheckboxTree::class,
            'checkboxCountries' => \Encore\Admin\Form\Field\CheckboxCountries::class,
            ...
            'hasManyNestable'   => \Encore\Admin\Form\Field\HasManyNestable::class,
            'hasManyLangTab'    => \Encore\Admin\Form\Field\HasManyLangTab::class,
            'hasManyRateOption' => \Encore\Admin\Form\Field\HasManyRateOption::class,
            'hidden'            => \Encore\Admin\Form\Field\Hidden::class,
            'fieldEmpty'        => \Encore\Admin\Form\Field\FieldEmpty::class,
            'id'                => \Encore\Admin\Form\Field\Id::class,
            'image'             => \Encore\Admin\Form\Field\Image::class,
            'ip'                => \Encore\Admin\Form\Field\Ip::class,
            'maps'               => \Encore\Admin\Form\Field\Map::class,
            ...
            'selectOnRateType'  => \Encore\Admin\Form\Field\SelectOnRateType::class,
            'multipleSelectFilters'    => \Encore\Admin\Form\Field\MultipleSelectFilters::class,
            ...
            'switchCallback'    => \Encore\Admin\Form\Field\SwitchCallback::class,
            ...
            'markdownEditor'    => \Encore\Admin\Form\Field\MarkdownEditor::class,
            'contentBuilder'    => \Encore\Admin\Form\Field\ContentBuilder::class,
